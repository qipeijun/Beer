...
export function summarizeSelection(filters = DEFAULT_FILTERS, defaultSummary = DEFAULT_SUMMARY) {
  const segments = [
    filters.crowd,
    filters.taste,
    filters.country,
...
export function getCardAnimationDelay(index = 0) {
...
export function initBeerGuide(config) {
...
export function bootBeerGuide(payload = window.BeerGuideData) {
  if (typeof document === "undefined") return false;
